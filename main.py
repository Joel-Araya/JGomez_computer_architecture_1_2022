...
def execute_assembly():
    result = subprocess.run(
        "arm-none-eabi-as bilinear_interpolation.s -g -o bilinear_interpolation.o && arm-none-eabi-ld bilinear_interpolation.o -o bilinear_interpolation && ./bilinear_interpolation",
        shell=True
    )
